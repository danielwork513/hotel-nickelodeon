...
export default function DesktopNavbar() {
  return (
    <header className="w-full relative md:flex hidden">
      <nav className="fixed z-20 top-8 left-8 right-8 flex items-center justify-between w-full max-w-7xl mx-auto bg-white/60 backdrop-blur-xl ring-4 ring-orange-600/50 p-2 px-10 rounded-full">
        <div>
          <img
